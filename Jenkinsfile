    ...
    stages {
        ...
        stage('Plan: 0-bootstrap') {
            ...
            steps {
                ...
                sh 'cd terraform/0-bootstrap && terraform import aws_s3_bucket.tf_state maruti22-infra-statefile-backup || true'
                sh 'cd terraform/0-bootstrap && terraform import aws_dynamodb_table.tf_lock maruti22-terraform-locks || true'
