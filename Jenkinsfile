    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                script {
                    dir('terraform') {
                        git url: 'https://github.com/Manoj-agni/Infrastructure.git', branch: 'main'
                    }
                }
            }
        }
        ...
        stage('Plan: 0-bootstrap') {
            ...
            steps {
                ...
                sh 'cd terraform/0-bootstrap && terraform import aws_s3_bucket.tf_state manoj-agni-infra-statefile-backup || true'
                sh 'cd terraform/0-bootstrap && terraform import aws_dynamodb_table.tf_lock manoj-agni-terraform-locks || true'
